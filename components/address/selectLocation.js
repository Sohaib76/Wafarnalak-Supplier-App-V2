...
export default class SelectLocationComponent extends React.Component {
  ...
  selectAddress = (address) => {
    ...
    let Newindex = addresses.findIndex(
      (x) => x.locationid === address.locationid
    );
      ...
      <Container>
        ...
        >
          ...
          <View style={{ marginBottom: 12, width: 120, alignSelf: "center" }}>
            <Button
              onPress={this.selectThisLocation}
              small
              rounded
              style={{ height: 40, backgroundColor: "#283a97" }}
            >
              <View>
